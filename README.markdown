...
If using a project wide constants file, name constants in this file in all uppercase, words separated by underscores.
...
```swift
private let _maximumWidgetCount = 100
